...
class Queue<E> {
    ...
    fun weave(q1: Queue<out E>, q2: Queue<out E>, q3: Queue<Any?>) { //fun weave( q1:misc.stackandqueue.Queue<*>, q2:misc.stackandqueue.Queue<*>, q3:misc.stackandqueue.Queue<*>) -> star-notation since we know nothing about the type; similar to <out E>
        while (true) {
